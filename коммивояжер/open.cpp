...
void makeGraph()
{
	...
	cout << "How many nodes are in the graph: "; cin >> amountVerts;
	cout << "How many paths: "; cin >> amountEdges;
	...
	{
		cout << "Start node: "; cin >> sourceVertex;
		cout << "Finish node: "; cin >> targetVertex;
		cout << "Way: "; cin >> edgeWeight;
